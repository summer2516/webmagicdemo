...
//        if(aaa) {
//            HashMap<String,String> map = pareMap();
//            System.out.println(map);
//            List<String> links = new ArrayList<>();
//            for (Map.Entry<String,String> entry : map.entrySet()) {
//                entry.getKey();
//                String value = entry.getValue();
//                 links.add("https://www.6456ri.com" + value);
//                //将这些链接加入到待抓取的队列中去
...
//        }
        ...
        //相同元素的结果加到相应的集合中去。
        List<String> titlelist = page.getHtml().xpath("//a[@title='下载地址1']/@href").all();
...
//            aMap.put(titlelist.get(i), readlist.get(i));
    ...
    public static HashMap pareMap(){
        ...
        HashMap map = new Gson().fromJson(mapString, HashMap.class);
        return map;
    }
